...
void SettingsManager::apply_defaults() {
  ...
  set_default("search_engine",
              std::string("https://search.brave.com/search?q="));
  ...
  const std::string default_dl =
      home_dir ? std::string(home_dir) + "/Downloads" : "/tmp";
...
void SettingsManager::load() {
  ...
  try {
    ...
    std::cerr << "[SettingsManager] Failed to load settings: " << e.what()
              << "\n";
  }
}
...
void SettingsManager::save() const {
  ...
  try {
    ...
    std::cerr << "[SettingsManager] Failed to save settings: " << e.what()
              << "\n";
  }
}
...
template std::string
SettingsManager::get<std::string>(const std::string &) const;
...
template void SettingsManager::set<std::string>(const std::string &,
                                                const std::string &);
...
void SettingsManager::on_change(
...
std::string SettingsManager::get_config_path() const {
  ...
  const std::string base =
      config_dir ? config_dir : (std::string(g_get_home_dir()) + "/.config");
